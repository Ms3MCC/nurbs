      ...
      init();
        ...
        scene.background = new THREE.Color( 'black' );
				...
				// NURBS surface
				{
					...
					const map = new THREE.TextureLoader().load( 'static/textures/d8rgrdp6aev71.png' );
          console.log(map)
        ...
        const statsDiv = stats.dom;

      // Scale the outer div
      statsDiv.style.transform = "scale(2)";
				container.style.touchAction = 'none';
        statsDiv.style.transformOrigin = "top left"; 
...
//     const map = new THREE.TextureLoader().load( '/public/static/textures/uv_grid_opengl.jpg' );
//     map.wrapS = map.wrapT = THREE.RepeatWrapping;
//     map.anisotropy = 16;
//     map.colorSpace = THREE.SRGBColorSpace;
